...
import { Container, ContactInfo, Footer, SubTextBox, TextBox, Address, Logo, About, SubTitle, Itens, Column, Content, List, Item, Div, Texte } from './styles';
  ...
  return(
      <Container>
        ...
        <Footer>
          <ContactInfo>
            <Logo src={LogoHexa}/>
            <Address>© 2020 hexaLAB - HEXALAB SOLUCOES EM 
              SOFTWARE LTDA | CNPJ 245463243/9098-00 | Rua
              Teófilo David Muzel, 639, Vila Ophelia, Itapeva/SP, 
              Brasil.
            </Address>
          </ContactInfo>
